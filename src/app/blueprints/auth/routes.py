...
def sign_up():
        ...
        new_user = User(public_id=str(uuid.uuid4()), first_name=data['first_name'], last_name=data['last_name'], email=data['email'],password_hash=hashed_password, email_confirmation_sent_on=datetime.datetime.utcnow())
